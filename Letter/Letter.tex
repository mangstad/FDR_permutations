...
\begin{figure*}[ht]
\IfFileExists{../Results/FDR_surviving_clusters.png}{\includegraphics[width=1.0\textwidth]{../Results/FDR_surviving_clusters.png}}{\includegraphics[width=1.0\textwidth]{FDR_surviving_clusters.png}}
\centering
\caption{
