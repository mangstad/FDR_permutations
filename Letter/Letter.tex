...
Based on our results (Figure \ref{fig:p-plot}), we can suggest that nearly all clusters identified as significant when using CDT=.001 and RFT-FWE correction are trustworthy by the nonparametric FDR benchmark.
...
While the story is more mixed for CDT=.01 (used in approximately 3,500 studies \cite{nichols_bibliometrics_2016,woo_cluster-extent_2014}), our findings suggest that not all clusters reported in the relevant studies are unreliable: we identify .00001 as a potential cutoff for trustworthiness.
